package br.com.gunbound.emulator.gameserver.packets.readers.lobby;
...
import br.com.gunbound.emulator.gameserver.packets.writers.GiftServerWriter;
import br.com.gunbound.emulator.gameserver.packets.writers.model.JoinChannelSuccessPacket;
...
public class LobbyJoin {
	...
	private static void putPlayerAtLobby(int channelId, PlayerSession player,
		...
		String channelMent = ServerConfig.getInstance().getGameServerChannelMent();
		String motd = channelMent != null ? channelMent : "[Developed By KyLL3R]"; // Mensagem do dia
		...
		//Verifica se tem aviso de gift para o player
		GiftServerWriter.checkPlayerReceivedAnyGift(player);
	}
