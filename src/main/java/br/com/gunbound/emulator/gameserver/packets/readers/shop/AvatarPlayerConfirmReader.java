...
public class AvatarPlayerConfirmReader {
	...
	public static void read(ChannelHandlerContext ctx, byte[] payload) {
		...
		// Hacky para decrementando a lista de itens que o player ganhou
		// *****Problema conhecido -> Se o player nao veste nenhum avatar a mensagem nao
		// para*****
		receiptService.updateReceiptGiftConfirmed(player);
